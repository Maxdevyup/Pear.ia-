...
Status 🚧
This project is in very early development. The codebase is just getting started. If you're here early — welcome, you're part of something from the very beginning.
Stars, feedback, and ideas are more than welcome.

Tech Stack
AI & Backend
Python · Hugging Face Transformers · PyTorch · Flask
Frontend
HTML · CSS · JavaScript
Desktop App
Electron
...
License
PolyForm Noncommercial 1.0 — free for personal and non-commercial use. Commercial use requires explicit permission from the author.
